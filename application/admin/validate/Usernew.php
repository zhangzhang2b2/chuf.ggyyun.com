...
* 
*/
class Usernew extends Validate
{
   protected $rule = [
        'username'       => 'require|min:2|max:30|unique:admin_user_new',
        'password'       => 'require|min:6|max:30',
        'check_password' => 'require|confirm:password',
        'mobile'		 => 'require|check_mobile_number|unique:admin_user_new',
        'email'          => 'require|email|unique:admin_user_new',
    ...
    protected $scene = [
        ...
        //编辑场景
        'edit'  => [
            'username' => 'require|min:5|max:30|unique:admin_user_new',
            'mobile' ,
            'email'    => 'require|email',
        ],
    ];
