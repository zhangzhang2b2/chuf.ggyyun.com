...
class WxPayApi
{
	...
	{
		$data=Db::table('wx_config')->find();

		$this->APPID = isset($options['x_appid'])?$options['x_appid']:$data['appid'];  //微信公众号appid
		$this->MCHID = isset($options['s_MCHID'])?$options['s_MCHID']:$data['s_MCHID'];
		$this->KEY = isset($options['s_KEY'])?$options['s_KEY']:$data['s_KEY'];
		$this->APPSECRET = isset($options['s_APPSECRET'])?$options['s_APPSECRET']:$data['s_APPSECRET'];

		// $this->APPID = isset($options['x_appid'])?$options['x_appid']:'wxd0b328297686eafb';  //微信公众号appid
		// $this->MCHID = isset($options['s_MCHID'])?$options['s_MCHID']:'1488014852';
		// $this->KEY = isset($options['s_KEY'])?$options['s_KEY']:'d27551c7803cf16015e536b192d5d03b';
		// $this->APPSECRET = isset($options['s_APPSECRET'])?$options['s_APPSECRET']:'d27551c7803cf16015e536b192d5d03b';
